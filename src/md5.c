 ...
 */
static void
byte_reverse (uint8_t *buf, uint32_t longs)
{
	uint32_t t;
 ...
 */
static void
md5_update (MD5Context *ctx, uint8_t const *buf, uint32_t len)
{
	uint32_t t;
 ...
 */
static void
md5_final (uint8_t digest[16], MD5Context *ctx)
{
	unsigned count;
	uint8_t *p;
